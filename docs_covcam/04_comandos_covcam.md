...
![Inyección de Comandos](img_covcam/comandos_covcam.png)
...
* Mitigación: Validar las entradas por medio de una lista blanca de caracteres permitidos y aislar el servicio en contenedores con permisos restringidos.